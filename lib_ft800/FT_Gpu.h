...
#define CLEAR_COLOR_X11(colour)     (((uint32_t)0x02<<24)|((uint32_t)(pgm_read_byte_near(&(colour)[0]))<<16)|((uint16_t)(pgm_read_byte_near(&(colour)[1]))<<8)|(pgm_read_byte_near(&(colour)[2])))
...
#define COLOR_X11(colour)           (((uint32_t)0x04<<24)|((uint32_t)(pgm_read_byte_near(&(colour)[0]))<<16)|((uint16_t)(pgm_read_byte_near(&(colour)[1]))<<8)|(pgm_read_byte_near(&(colour)[2])))
...
#define X11(colour)					(((uint32_t)(pgm_read_byte_near(&(colour)[0]))<<16)|((uint16_t)(pgm_read_byte_near(&(colour)[1]))<<8)|(pgm_read_byte_near(&(colour)[2])))
